...
namespace SugarProductionManagement.Filter {
    public class PagRfVenda : ActionFilterAttribute{
        public override void OnActionExecuting(ActionExecutingContext filterContext) {
            ...
            if (string.IsNullOrEmpty(sectionUser)) {
                ...
                if (usuario!.Departamento != Departamento.Vendas && usuario.Departamento != Departamento.Administracao && usuario.Departamento != Departamento.Carregamento) {
